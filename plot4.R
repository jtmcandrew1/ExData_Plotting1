...
with(plot_data, plot(Time, Global_active_power, xlab="", ylab="Global Active Power", type="l"))

with(plot_data, plot(Time, Voltage, xlab="datetime", ylab="Voltage", type="l"))
...
legend("topright",text,col=c("black", "red","blue"), lty=1, bty="n",
       text.width = strwidth(text)[1]*1.7)


with(plot_data, plot(Time, Global_reactive_power, xlab="datetime", type="l"))
